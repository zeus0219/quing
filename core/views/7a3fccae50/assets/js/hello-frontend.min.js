  ...
  class elementorHelloThemeHandler {
    ...
    bindEvents() {
      ...
      if (
        ...
        ((_this$elements$menuTo = this.elements.menuToggleHolder) !== null &&
          _this$elements$menuTo !== void 0 &&
          _this$elements$menuTo.classList.contains("hide"))
      ) {
        return;
      }
    ...
    handleMenuToggle() {
      ...
      this.elements.dropdownMenu.setAttribute(
        "aria-hidden",
        !isDropdownVisible
      );
